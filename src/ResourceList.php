...
final class ResourceList extends Component
{
    ...
    public function save(): void
    {
        ...
        if ($this->editingId === null) {
            EvaluationResource::query()->create(['team_id' => $teamId, ...$attributes]);
        } else {
    ...
    {
        return view('module-automation-evaluation-livewire::resource-list', [
    ...
    private function query()
    {
        ...
        return EvaluationResource::query()->when(
            $teamId === null,
