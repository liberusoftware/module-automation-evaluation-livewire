<div>
    <form wire:submit="save">
        ...
        <input id="evaluation-name" type="text" wire:model="name" required>
        <label for="evaluation-status">Status</label>
        <select id="evaluation-status" wire:model="status">
        ...
        <label for="evaluation-payload">Payload (JSON)</label>
        <textarea id="evaluation-payload" wire:model="payload"></textarea>
