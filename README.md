...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-automation-evaluation-livewire?sort=semver)](https://github.com/liberusoftware/module-automation-evaluation-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-automation-evaluation-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-automation-evaluation-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-automation-evaluation-livewire
```
...
<a href="https://github.com/liberusoftware/module-automation-evaluation-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-automation-evaluation-livewire" alt="Contributors to liberusoftware/module-automation-evaluation-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-automation-evaluation-livewire/graphs/contributors).
